...
include device/kurzschluss/nokia3210/build_id.mk
include device/fsl/imx7/BoardConfigCommon.mk

# nokia3210 default target for EXT4
...
TARGET_BOOTLOADER_BOARD_NAME := RETROFIT
PRODUCT_MODEL := NOKIA3210
...
# camera hal v1
IMX_CAMERA_HAL_V1 := false
TARGET_VSYNC_DIRECT_REFRESH := false
...
BOARD_SEPOLICY_DIRS := \
       ...
       device/kurzschluss/nokia3210/sepolicy

BOARD_SECCOMP_POLICY += device/kurzschluss/nokia3210/seccomp
